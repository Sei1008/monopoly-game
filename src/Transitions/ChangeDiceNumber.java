...
public class ChangeDiceNumber implements ITransitionStrategy {
    ...
    public ChangeDiceNumber(ImageView image1, ImageView image2, ImageView image3, ImageView image4,
                           ImageView image5, ImageView image6, ImageView dice1, ImageView dice2) {
        super();
    ...
    public void run() {
        if (this.var_show_images < 6) {
            ...
            if (this.var_show_images == 2) {
                this.dice1.setImage(this.images[5].getImage());
                this.dice2.setImage(this.images[5].getImage());
            } else {
